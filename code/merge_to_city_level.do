...
// only consider eviction rate as independent variable of interest
drop evictionfilingrate evictions

// reshape long so that each row represents one city-year-grade
rename *_ *
